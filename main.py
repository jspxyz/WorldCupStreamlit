...
# 2.3.2 Function to determine Home or Away Team winner for each match
# score1, score2
...
matches['HalftimeWin'] = matches[['Home Team Name', 'Away Team Name', 'Half-time Home Goals', 'Half-time Away Goals']].apply(HalftimeWinFunc, axis = 1)
